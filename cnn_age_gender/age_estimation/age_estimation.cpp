...
std::vector<Age> age_estimation(const cv::Mat& Image, const std::vector<BoundingBox>& face_rois)
{
    ...
    std::shared_ptr<caffe::Net<double>> net(new caffe::Net<double>(project_root+"deploy_age.prototxt", caffe::Phase::TEST));
    ...
    for(const auto& face_roi:face_rois)
    {
        ...
        {
            case 0: ages.push_back(Age::R0_2);
                break;
            case 1: ages.push_back(Age::R4_6);
                break;
            case 2: ages.push_back(Age::R8_13);
                break;
            case 3: ages.push_back(Age::R15_20);
                break;
            case 4: ages.push_back(Age::R25_32);
                break;
            case 5: ages.push_back(Age::R38_43);
                break;
            case 6: ages.push_back(Age::R48_53);
                break;
            case 7: ages.push_back(Age::R60_);
                break;
            default:
                ages.push_back(Age::Error);
                break;
        }
